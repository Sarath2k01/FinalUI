...
Future<void> makePostRequest(String ip, String name) async {
...
class SelectedTeamScreen extends StatefulWidget {
  ...
  SelectedTeamScreen({Key? key, required this.teamname}) : super(key: key);
...
class _SelectedTeamScreenState extends State<SelectedTeamScreen> {
  ...
  void searchAppointments(String value) {
    setState(() {
      searchlist = mylist
          .where((element) =>
              element.type == 'GGR' &&
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      itemCount: searchlist
                          .where((element) => element.type == 'GGR')
                          .length,
                      itemBuilder: (_, i) {
