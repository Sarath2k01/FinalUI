...
class SelenoidScreen extends StatefulWidget {
  const SelenoidScreen({Key? key}) : super(key: key);

  @override
  _SelenoidScreenState createState() => _SelenoidScreenState();
}

class _SelenoidScreenState extends State<SelenoidScreen> {
        ...
        children: [
          ...
          Expanded(
            ...
            itemCount: searchlist
                .where((element) => element.type == "Selenoid")
                .length,
            itemBuilder: (_, i) {
