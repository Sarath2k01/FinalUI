...
class JenkinsScreen extends StatefulWidget {
  const JenkinsScreen({Key? key}) : super(key: key);

  @override
  _JenkinsScreenState createState() => _JenkinsScreenState();
}

class _JenkinsScreenState extends State<JenkinsScreen> {
      ...
      child: Column(
        children: [
          ...
          Expanded(
            ...
            itemCount:
                searchlist.where((element) => element.type == "Jenkins").length,
            itemBuilder: (_, i) {
              final filteredList = searchlist
                  .where((element) => element.type == "Jenkins")
                  .toList();
              return Row(
                children: [
                  Expanded(
